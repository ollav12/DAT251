...
public class ChallengeTests {
        ...
        void testCreateChallenge() {
                 ...
                 * assertEquals(Challenge.ChallengeType.ACTION,
                 * createdChallenge.getChallengeType());
                 */
        }
        ...
        void testAssignChallengeToUser() {
                ...
                ResponseEntity<ChallengeStatus> response = restTemplate.postForEntity(
                                "/users/" + testUser.getId() + "/challenges/" + actionChallenge.getChallengeID()
                                                + "/start",
                                null,
        ...
        void testChallengeStatusChangesToCompletedWhenMetricReachesTarget() {
                ...
                restTemplate.postForEntity(
                                "/challenges/users/" + testUser.getId() + "/challenges/"
                                                + metricChallenge.getChallengeID()
                                                + "/metrics",
